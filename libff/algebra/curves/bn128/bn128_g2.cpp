...
namespace libff
{
    ...
    void bn128_G2::fill_coord(std::array<bn::Fp2, 3> coord) const
    {
        coord[0] = *this->X;
        coord[1] = *this->Y;
        coord[2] = *this->Z;
    ...
    bn128_G2 bn128_G2::add(const bn128_G2 &other) const
    {
        ...
        std::array<bn::Fp2,3> this_coord, other_coord, result_coord;
    ...
    bn128_G2 bn128_G2::dbl() const
    {
        ...
        std::array<bn::Fp2,3> this_coord, result_coord;
        this->fill_coord(this_coord);

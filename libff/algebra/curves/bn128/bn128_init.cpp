...
namespace libff
{
    ...
    void init_bn128_params()
    {
        ...
        /* choice of group G1 */
        bn128_G1::G1_zero.X = std::make_unique<bn::Fp>(1);
        bn128_G1::G1_zero.Y = std::make_unique<bn::Fp>(1);
        bn128_G1::G1_zero.Z = std::make_unique<bn::Fp>(0);

        bn128_G1::G1_one.X = std::make_unique<bn::Fp>(1);
        bn128_G1::G1_one.Y = std::make_unique<bn::Fp>(2);
        bn128_G1::G1_one.Z = std::make_unique<bn::Fp>(1);
        ...
        /* choice of group G2 */
        bn128_G2::G2_zero.X = std::make_unique<bn::Fp2>(bn::Fp(1), bn::Fp(0));
        bn128_G2::G2_zero.Y = std::make_unique<bn::Fp2>(bn::Fp(1), bn::Fp(0));
        bn128_G2::G2_zero.Z = std::make_unique<bn::Fp2>(bn::Fp(0), bn::Fp(0));

        bn128_G2::G2_one.X = std::make_unique<bn::Fp2>(bn::Fp("15267802884793550383558706039165621050290089775961208824303765753922461897946"),
                                      bn::Fp("9034493566019742339402378670461897774509967669562610788113215988055021632533"));
        bn128_G2::G2_one.Y = std::make_unique<bn::Fp2>(bn::Fp("644888581738283025171396578091639672120333224302184904896215738366765861164"),
                                      bn::Fp("20532875081203448695448744255224543661959516361327385779878476709582931298750"));
        bn128_G2::G2_one.Z = std::make_unique<bn::Fp2>(bn::Fp(1), bn::Fp(0));
        ...
        bn128_GT::GT_one.elem = std::make_unique<bn::Fp12>(1);
    }
} // namespace libff
